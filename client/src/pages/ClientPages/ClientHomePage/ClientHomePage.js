...
const ClientHomePage = () => {
  ...
  const requestedSongSubmitHandler = useCallback(
    (event) => {
      event.preventDefault();
      dispatch(
        addClientRequestedSongAction(requestedSongName, requestedArtistName)
      );
  ...
  const doNotPlaySongSubmitHandler = useCallback(
    (event) => {
      event.preventDefault();
      dispatch(
        addClientDoNotPlaySongAction(doNotPlaySongName, doNotPlayArtistName)
      );
  ...
  const deleteSongHandler = useCallback(
    (songId) => {
    ...
    return (
      <div className={styles.clientHomePageContainer}>
        ...
        <LinkButton
          route={
            clientApproved
              ? "/client/finalizedSetList"
              : "/client/setListApproval"
          }
        >
          {clientApproved
            ? "Get Finalized SetList"
            : "Look at Proposed SetList"}
        </LinkButton>
      </div>
    );
  }
    ...
    <div className={styles.clientHomePageContainer}>
      ...
      <div className={styles.songsContainer}>
        <div className={styles.requestedSongsContainer}>
          ...
          <form
            className={styles.addSongFormContainer}
            onSubmit={requestedSongSubmitHandler}
          >
            <Input
            ...
            />
            <Button title="Add Requested Song" type="Submit" />
          </form>
          <div className={styles.songsContainer}>
        ...
        <div className={styles.doNotPlaySongsContainer}>
          ...
          <form
            className={styles.addSongFormContainer}
            onSubmit={doNotPlaySongSubmitHandler}
          >
            <Input
            ...
            />
            <Button title="Add Do Not Playlist Song" type="Submit" />
          </form>
          <div className={styles.songsContainer}>
