...
describe("<ClientHomePage/>", () => {
  describe("Set List Available", () => {
    ...
    test("Finalized Setlist button goes to correct route when Set List is finalized and Client Approved", async () => {
      ...
      jest.spyOn(axios, "get").mockResolvedValueOnce({
        data: { ...getFinalizedSetListInfoResponse },
      });
    ...
    test("Proposed Setlist button goes to correct route when Set List is finalized and isn't Client Approved", async () => {
      ...
      jest.spyOn(axios, "get").mockResolvedValueOnce({
        data: { ...getCompletedSetListInfoResponse },
      });
  ...
  describe("Set List Isn't available", () => {
    ...
    test("Added Requested Song displays", async () => {
      ...
      fireEvent.change(screen.getByTestId("Requested Song NameTextInput"), {
        target: { value: "Uptown Funk" },
      });
      expect(screen.getByTestId("Requested Song NameTextInput").value).toEqual(
        "Uptown Funk"
      );

      fireEvent.change(screen.getByTestId("Requested Artist NameTextInput"), {
        target: { value: "Bruno Mars" },
      });
      expect(
        screen.getByTestId("Requested Artist NameTextInput").value
      ).toEqual("Bruno Mars");
      ...
      jest.spyOn(axios, "post").mockResolvedValueOnce({
        data: { ...addClientRequestedSongActionResponse },
      });
    ...
    test("Added do not play song displays", async () => {
      ...
      fireEvent.change(screen.getByTestId("Do Not Play Song NameTextInput"), {
        target: { value: "Uptown Funk" },
      });
      expect(
        screen.getByTestId("Do Not Play Song NameTextInput").value
      ).toEqual("Uptown Funk");

      fireEvent.change(screen.getByTestId("Do Not Play Artist NameTextInput"), {
        target: { value: "Bruno Mars" },
      });
      expect(
        screen.getByTestId("Do Not Play Artist NameTextInput").value
      ).toEqual("Bruno Mars");
      ...
      jest.spyOn(axios, "post").mockResolvedValueOnce({
        data: { ...addClientDoNotPlaySongActionResponse },
      });
    ...
    test("Edit song button redirects to edit song page", async () => {
      ...
      jest
        .spyOn(axios, "get")
        .mockResolvedValueOnce({ data: { ...getSongResponse } });
