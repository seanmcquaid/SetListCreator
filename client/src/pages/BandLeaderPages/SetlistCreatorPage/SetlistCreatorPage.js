...
const SetListCreatorPage = (props) => {
  ...
  const sendCompletedSetlist = useCallback(() => {
    ...
    axios
      .post(`${apiHost}/bandleader/postCompletedSetList`, requestBody, config)
      .then(() => {
  ...
  return (
    <div className={styles.setListCreatorPageContainer}>
      <div className={styles.headerContainer}>
        ...
        <Button
          type="button"
          title="Send Set List to Client"
          onClick={sendCompletedSetlist}
        />
      </div>
      <div className={styles.commentsContainer}>
        ...
        <Button
          type="button"
          title="Add Comment"
          onClick={addSetListCommentHandler}
        />
      </div>
