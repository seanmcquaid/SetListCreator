...
const ClientListPage = () => {
  ...
  const clientPageRedirect = useCallback(
    (clientId) => {
  ...
  const clientFinalSetListPageRedirect = useCallback(
    (clientId) => {
  ...
  const clientEditSetListPageRedirect = useCallback(
    (clientId) => {
        ...
        {clientList.map((clientInfo) => (
          <ClientInfo
            ...
            clientFinalSetListPageRedirect={() =>
              clientFinalSetListPageRedirect(clientInfo.id)
            }
            clientApproved={clientInfo.clientapproved}
            clientEditSetListPageRedirect={() =>
              clientEditSetListPageRedirect(clientInfo.id)
            }
          />
        ))}
      </div>
