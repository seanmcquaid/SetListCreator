...
export const addBandleaderSongAction = (songName, artistName, songKey) => (
  dispatch
) => {
  ...
  return axios
    .post(`${apiHost}/bandleader/addSong`, requestBody, config)
    .then((response) => {
      dispatch({
...
export const deleteBandleaderSongAction = (songId) => (dispatch) => {
  ...
  return axios
    .delete(`${apiHost}/bandleader/deleteSong/${songId}`, config)
    .then((response) => {
      dispatch({
...
export const getBandleaderSongsAction = () => (dispatch) => {
  ...
  return axios
    .get(`${apiHost}/bandleader/getSongs`, config)
    .then((response) => {
      dispatch({
...
export const editBandleaderSongAction = (
  songName,
  artistName,
  songKey,
  songId
  ...
  return axios
    .patch(`${apiHost}/bandleader/editSong/${songId}`, requestBody, config)
    .then((response) => {
      dispatch({
...
export const getBandleaderClientsAction = () => (dispatch) => {
  ...
  return axios
    .get(`${apiHost}/users/getClientsForBandleader`, config)
    .then((response) => {
      dispatch({
