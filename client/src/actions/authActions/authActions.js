...
export const loginAction = (username, password, accountType) => async (
  dispatch
) => {
  ...
  return axios
    .post(`${apiHost}/users/login/${accountType}`, requestBody, config)
    .then((response) => {
      dispatch({
        type: LOGIN_SUCCESS,
...
export const registerAction = (
  ...
  return axios
    .post(`${apiHost}/users/register/${accountType}`, requestBody, config)
    .then((response) => {
      dispatch({
...
export const checkTokenAction = () => async (dispatch) => {
  ...
  return axios
    .get(`${apiHost}/users/checkToken`, config)
    .then((response) => {
      dispatch({
...
export const editUserInfoAction = (
  ...
  return axios
    .patch(`${apiHost}/users/editUserInfo`, requestBody, config)
    .then((response) => {
      dispatch({
...
export const getUserInfoAction = () => (dispatch) => {
  ...
  return axios
    .get(`${apiHost}/users/getUserInfo`, config)
    .then(async (response) => {
      dispatch({
