describe("Client Register", () => {
  ...
  it("Successful register redirects client to home page", () => {
    ...
    cy.get("[data-testid='Confirm PasswordTextInput']").should(
      "have.value",
      "password1234"
    );
    ...
    cy.get('[data-testid="Select Your BandleaderDropdown"]').should(
      "have.value",
      "testbandleader1234"
    );

    cy.get("[data-testid=RegisterButton]").should("be.visible").click();
