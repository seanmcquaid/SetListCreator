describe("Client Set List", () => {
  ...
  afterEach(() => {
    cy.deleteAllBandleaderSongsAndSetList(
      "testclient1234",
      "testbandleader1234"
    );
  });
  ...
  describe("Client Set List Ready", () => {
    ...
    it("Create Set List For Client", () => {
      ...
      cy.get(
        "[data-testid=testclient1234Info] > [data-testid=paragraphText]"
  ...
  describe("Complete", () => {
    ...
    it("View Final Set List", () => {
      ...
      cy.contains("Final Set List For testclient1234").should("be.visible");
