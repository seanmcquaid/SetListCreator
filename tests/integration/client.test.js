    ...
    it("addSong", (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          expect(res.body.setListAvailable).to.be.equal(
            expectedResponse.setListAvailable
          );
          expect(res.body.clientApproved).to.be.equal(
    ...
    it("getCompletedSetList", async () => {
      chai
        ...
        .end((err, res) => {
          ...
          expect(res.body.bandleaderName).to.equal(
            expectedResponse.bandleaderName
          );
          expect(res.body.suggestedSetList).to.equals(
            expectedResponse.suggestedSetList
          );
          expect(res.body.bandleaderComments).to.equal(
    ...
    it("editCompletedSetListComments", async () => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          expect(res.body.setListInfo.clientname).to.equal(
            expectedResponse.clientName
          );
          expect(res.body.setListInfo.bandleadername).to.equal(
            expectedResponse.bandleaderName
          );
          expect(res.body.setListInfo.setlist).to.equal(
            expectedResponse.setList
          );
          expect(res.body.setListInfo.bandleadercomments).to.equal(
            expectedResponse.bandleaderComments
          );
          expect(res.body.setListInfo.clientcomments).to.equal(
            expectedResponse.clientComments
          );
          expect(res.body.setListInfo.clientapproved).to.equal(
            expectedResponse.clientApproved
          );
