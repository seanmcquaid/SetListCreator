...
describe("User Routes", () => {
      ...
      it("register creates a new user", (done) => {
        chai
          ...
          .end((err, res) => {
            ...
            expect(res.body.isAuthenticated).to.equal(
              expectedResponse.isAuthenticated
            );
            ...
            expect(res.body.setListAvailable).to.equal(
              expectedResponse.setListAvailable
            );
            expect(res.body.selectedBandleader).to.equal(
              expectedResponse.selectedBandleader
            );
  ...
  describe("Login", () => {
    ...
    describe("Login works", () => {
      before(
        async () =>
          await UsersModel.register(username, password, "bandleader", null)
      );
    ...
    it("clientInfo works", (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          expect(clientInfo.bandleadername).to.equal(
            expectedResponse.bandleaderName
          );
          expect(clientInfo.setlistavailable).to.equal(
            expectedResponse.setlistAvailable
          );
    ...
    it("getUserInfo works", (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          expect(userInfo.isAuthenticated).to.equal(
            expectedResponse.isAuthenticated
          );
