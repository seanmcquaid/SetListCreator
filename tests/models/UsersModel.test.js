...
describe("UsersModel", () => {
    ...
    it("userExists returns as expected", async () => {
      return await UsersModel.userExists(username)
        .then((response) => {
          ...
          expect(userInfoResponse.accounttype).to.equal(
            expectedResponse.accountType
          );
          expect(userInfoResponse.bandleadername).to.equal(
            expectedResponse.bandleaderName
          );
          expect(userInfoResponse.setlistavailable).to.equal(
  ...
  describe("setClientSetListAvailability", () => {
    ...
    it("setClientSetlistAvailability works", async () => {
      return UsersModel.setClientSetListAvailability(
        userInfo.username,
        body.setlistAvailability
      )
        .then((response) => {
          const expectedResponse = {
            username: "testClient",
