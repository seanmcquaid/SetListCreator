...
describe("SetListsModel", () => {
    ...
    it("addSetList", async () => {
      return await SetListsModel.addSetList(
        ...
        .then((response) => {
          ...
          expect(setListInfoResponse.clientname).to.equal(
            expectedResponse.clientName
          );
          expect(setListInfoResponse.bandleadername).to.equal(
            expectedResponse.bandleaderName
          );
          expect(setListInfoResponse.setlist).to.equal(
            expectedResponse.setList
          );
          expect(setListInfoResponse.bandleadercomments).to.equal(
            expectedResponse.bandleaderComments
          );
          expect(setListInfoResponse.clientcomments).to.equal(
            expectedResponse.clientComments
          );
          expect(setListInfoResponse.clientapproved).to.equal(
            expectedResponse.clientApproved
          );
        })
  ...
  describe("getSetList", () => {
    ...
    after(
      async () => await SetListsModel.deleteSetList(clientName, bandleaderName)
    );
  });
  ...
  describe("addClientCommentsAndApprovalStatus", () => {
    ...
    it("addClientCommentsAndApprovalStatus", async () => {
      return await SetListsModel.addClientCommentsAndApprovalStatus(
        clientName,
        clientComments,
        clientApproved
      ).then((response) => {
        ...
        expect(setListInfoResponse.bandleadercomments).to.eql(
          expectedResponse.bandleaderComments
        );
        expect(setListInfoResponse.clientcomments).to.eql(
          expectedResponse.clientComments
        );
        expect(setListInfoResponse.clientapproved).to.equal(
          expectedResponse.clientApproved
  ...
  describe("editSetList", () => {
    ...
    it("editSetList", async () => {
      return await SetListsModel.editSetList(
        updatedSetListInfo.clientName,
        updatedSetListInfo.bandleaderName,
        updatedSetListInfo.setList,
        updatedSetListInfo.bandleaderComments
      ).then((response) => {
        const expectedResponse = {
          clientName: "addtestclient@gmail.com",
          bandleaderName: "addtestleader@gmail.com",
